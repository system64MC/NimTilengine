...
proc enableCRTEffect*(overlay: Overlay, factor: uint8, threshold: uint8, v0: uint8, v1: uint8, v2: uint8, v3: uint8, blur: bool, glowFactor: uint8): void =
    TLN_EnableCRTEffect(overlay.TLN_Overlay, factor, threshold, v0, v1, v2, v3, blur, glowFactor)
